"""KDE-compatible StatusNotifierItem tray for Linux desktops.

Imported lazily by :mod:`tuxflow.tray` so that the daemon still starts on
platforms without D-Bus.
"""
